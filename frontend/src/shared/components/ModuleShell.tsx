      ...
      <div className="flex flex-col gap-4 px-5 py-4 lg:flex-row lg:items-center lg:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-500">
            Your at-a-glance workspace for devices, service health, alerts, and security.
          </p>
        </div>
        <div className="flex flex-wrap gap-2">
          <Link href="/assets" className="inline-flex items-center gap-2 rounded-lg border border-slate-200 px-3 py-2 text-xs font-semibold text-slate-700 hover:border-indigo-200 hover:bg-indigo-50 hover:text-indigo-700">
            <Activity size={14} /> Devices
          </Link>
          <Link href="/itsm" className="inline-flex items-center gap-2 rounded-lg border border-slate-200 px-3 py-2 text-xs font-semibold text-slate-700 hover:border-indigo-200 hover:bg-indigo-50 hover:text-indigo-700">
            <Ticket size={14} /> Tickets
          </Link>
          <Link href="/endpoint-security" className="inline-flex items-center gap-2 rounded-lg border border-slate-200 px-3 py-2 text-xs font-semibold text-slate-700 hover:border-indigo-200 hover:bg-indigo-50 hover:text-indigo-700">
  ...
  return (
    <AppShell title={title}>
      <div className="flex min-h-0 flex-1 flex-row overflow-hidden">
        <main ref={contentRef} className="min-h-0 min-w-0 flex-1 overflow-y-auto overscroll-contain">
            ...
            {(title || subtitle || actions) && (
              <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
                ...
                <div className="flex flex-wrap items-center gap-2">
                  {actions}
                  {title === 'Dashboard' && (
                    <Link href="/reporting" className="inline-flex items-center gap-1 text-xs font-semibold text-indigo-600 hover:text-indigo-500">
