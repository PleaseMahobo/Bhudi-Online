...
_safe_include("app.api.v1.endpoints.monitoring_hardware", prefix="/monitoring", tags=["monitoring"])
_safe_include("app.api.v1.endpoints.device_health", tags=["Device Health"])
