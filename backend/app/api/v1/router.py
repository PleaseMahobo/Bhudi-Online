...
_safe_include("app.api.v1.endpoints.platform_heal", tags=["auth"])
...
_safe_include("app.api.v1.endpoints.billing_entitlement", tags=["billing"])
_safe_include("app.api.v1.endpoints.billing_admin", tags=["billing"])
...
_safe_include("app.api.v1.endpoints.msp_customers", tags=["MSP Multi-Tenant"])
...
_safe_include("app.api.v1.endpoints.agent_installer", tags=["Agent Installer"])
