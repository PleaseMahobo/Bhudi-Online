...
def _ensure_table(conn) -> None:
    ...
    with _SCHEMA_LOCK:
        ...
        for stmt in (
            "ALTER TABLE device_metrics ADD COLUMN IF NOT EXISTS temperature_c NUMERIC NULL",
            "ALTER TABLE device_metrics ADD COLUMN IF NOT EXISTS smart_status TEXT NULL",
        ):
            try:
        ...
        session.execute(
            text(
                ...
                INSERT INTO device_metrics (
                    id, device_id, cpu_usage, ram_usage, disk_usage,
                    temperature_c, smart_status, recorded_at
                )
                VALUES (
                    :id, :device_id, :cpu, :ram, :disk,
                    :temperature_c, :smart_status, :recorded_at
                )
                """
            ),
            ...
            rows.append(
                {
                    ...
                    "smart_status": s.get("smart_status"),
    ...
    try:
        ...
        if SessionLocal is not None:
            ...
            try:
                ...
                for cpu, ram, disk, temp, smart, recorded_at in result:
